...
variable "cluster_policy_use_name_prefix" {
  description = "Determines whether cluster policy name (`cluster_policy_name`) is used as a prefix"
  type        = bool
  default     = true
}

variable "cluster_policy_name" {
  description = "Name to use on cluster policy created"
  type        = string
  default     = null
}

variable "cluster_policy_description" {
  description = "Description of the cluster policy created"
  type        = string
  default     = "Minimal Cluster policy to allow cluster role to manage nodes"
}
...
variable "cluster_policy_tags" {
  description = "A map of additional tags to add to the cluster policy created"
  type        = map(string)
  default     = {}
}
